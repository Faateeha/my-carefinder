...
const About: React.FC = () => {
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-8 bg-white">
        ...
        <Text fontSize="lg">
          Carefinder is built using modern web technologies including Next.js, TypeScript, Chakra UI, and Tailwind CSS. We also leverage Firebase for authentication and data storage, ensuring a secure and seamless user experience.
        </Text>
        ...
        <Text fontSize="lg">
          If you have any questions, feedback, or need support, please feel free to <Link href="/contact" color="purple.500" className="hover:underline">contact us</Link>.
        </Text>
